...
urlpatterns = [
    ...
    path("driver-dashboard/bus-control/", views.driver_tracking_page, name="driver_tracking"),
    path('driver-dashboard/', views.driver_dashboard, name='driver_dashboard'),
    path('driver/scan-qr/', views.scan_student_qr, name='scan_student_qr'),
    path("student-application/", views.student_application, name="student_application"),
    path("admin_dashboard/student-register/", views.student_register, name="student_register"),
    path('admin_dashboard/students/update/<int:student_id>/', views.update_student, name='update_student'),
    ...
    path('api/validate-admission-number/', views.validate_admission_number, name='validate_admission_number'),
